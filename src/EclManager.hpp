...
enum EclRawInstrOpcode
{
    ...
    ECL_OPCODE_MATHINTMOD, //17
    ECL_OPCODE_MATHINC, //18
    ECL_OPCODE_MATHDEC, //19
    ECL_OPCODE_MATHFLOATADD, //20
    ...
    ECL_OPCODE_CALL,
    ECL_OPCODE_RET,
    ECL_OPCODE_CALLLSS, // 37
    ECL_OPCODE_CALLLEQ,
    ECL_OPCODE_CALLEQU,
    ECL_OPCODE_CALLGRE,
    ECL_OPCODE_CALLGEQ,
    ECL_OPCODE_CALLNEQ,
    ECL_OPCODE_MOVEPOSITION,//43
    ECL_OPCODE_MOVEAXISVELOCITY,//44
    ECL_OPCODE_MOVEVELOCITY,//45
    ECL_OPCODE_MOVEANGULARVELOCITY, //46
    ...
    ECL_OPCODE_MOVEPOSITIONTIMEDECELERATE, // 57
    ...
    ECL_OPCODE_ENEMYFLAGINVISIBLE, //132
