...
#undef COMPAT_CONTROLLER_BUTTON_DPAD_UP
...
#define START_TEXT_INPUT_COMPAT() SDL_START_TEXT_INPUT_COMPAT()
#define STOP_TEXT_INPUT_COMPAT() SDL_STOP_TEXT_INPUT_COMPAT()

#define COMPAT_TimerCallback SDL_TimerCallback
#define COMPAT_TimerID SDL_TimerID

#undef COMPAT_CONTROLLER_BUTTON_A              
#undef COMPAT_CONTROLLER_BUTTON_B              
#undef COMPAT_CONTROLLER_BUTTON_X              
#undef COMPAT_CONTROLLER_BUTTON_Y              
#undef COMPAT_CONTROLLER_BUTTON_LEFTSHOULDER   
#undef COMPAT_CONTROLLER_BUTTON_RIGHTSHOULDER  
#undef COMPAT_CONTROLLER_BUTTON_DPAD_UP
#undef COMPAT_CONTROLLER_BUTTON_DPAD_DOWN
#undef COMPAT_CONTROLLER_BUTTON_DPAD_LEFT
#undef COMPAT_CONTROLLER_BUTTON_DPAD_RIGHT
#undef COMPAT_CONTROLLER_BUTTON_BACK           
#undef COMPAT_CONTROLLER_BUTTON_START          
#undef COMPAT_CONTROLLER_BUTTON_LEFTSTICK      
#undef COMPAT_CONTROLLER_BUTTON_RIGHTSTICK     
#undef JOYSTICK_COMPAT
#undef JOYSTICK_COMPATButton
#undef JOYSTICK_COMPATGetJoystick
#undef CONTROLLER_AXIS_LEFTX
#undef CONTROLLER_AXIS_LEFTY
#undef CONTROLLER_AXIS_RIGHTX
#undef CONTROLLER_AXIS_RIGHTY
#undef JOYSTICK_COMPATHasAxis
#undef JOYSTICK_COMPATGetAxis
#undef JOYSTICK_COMPATGetButton
#undef JOYSTICK_COMPATOpen
#undef JOYSTICK_COMPATClose
#undef PUMP_EVENTS_COMPAT

#define COMPAT_CONTROLLER_BUTTON_A SDL_CONTROLLER_BUTTON_A
#define COMPAT_CONTROLLER_BUTTON_B SDL_CONTROLLER_BUTTON_B
#define COMPAT_CONTROLLER_BUTTON_LEFTSHOULDER SDL_CONTROLLER_BUTTON_LEFTSHOULDER
#define COMPAT_CONTROLLER_BUTTON_START SDL_CONTROLLER_BUTTON_START
#define COMPAT_CONTROLLER_BUTTON_DPAD_UP SDL_CONTROLLER_BUTTON_DPAD_UP
#define COMPAT_CONTROLLER_BUTTON_DPAD_DOWN SDL_CONTROLLER_BUTTON_DPAD_DOWN
#define COMPAT_CONTROLLER_BUTTON_DPAD_LEFT SDL_CONTROLLER_BUTTON_DPAD_LEFT
#define COMPAT_CONTROLLER_BUTTON_DPAD_RIGHT SDL_CONTROLLER_BUTTON_DPAD_RIGHT
#define COMPAT_CONTROLLER_BUTTON_RIGHTSHOULDER SDL_CONTROLLER_BUTTON_RIGHTSHOULDER
#define JOYSTICK_COMPAT                  SDL_JOYSTICK_COMPAT
#define JOYSTICK_COMPATButton            SDL_JOYSTICK_COMPATButton
#define JOYSTICK_COMPATGetJoystick SDL_JOYSTICK_COMPATGetJoystick
...
#define JOYSTICK_COMPATHasAxis SDL_JOYSTICK_COMPATHasAxis
#define JOYSTICK_COMPATGetAxis SDL_JOYSTICK_COMPATGetAxis
#define JOYSTICK_COMPATGetButton SDL_JOYSTICK_COMPATGetButton
#define JOYSTICK_COMPATOpen SDL_JOYSTICK_COMPATOpen
#define JOYSTICK_COMPATClose SDL_JOYSTICK_COMPATClose
#define PUMP_EVENTS_COMPAT SDL_PUMP_EVENTS_COMPAT
#define COMPAT_CONTROLLER_BUTTON_MAX SDL_CONTROLLER_BUTTON_MAX_COMPAT

// Window Compat
#define HIDECURSOR_COMPAT SDL_HIDECURSOR_COMPAT
#define SHOWCURSOR_COMPAT SDL_SHOWCURSOR_COMPAT

// Audio Compat

#undef AUDIO_STREAM_COMPAT
#undef COMPAT_AudioSpec
#undef COMPAT_Thread
#undef RWOPS_COMPAT

#define AUDIO_STREAM_COMPAT SDL_AUDIO_STREAM_COMPAT
#define COMPAT_AudioSpec SDL_AudioSpec
#define COMPAT_Thread SDL_Thread
#define RWOPS_COMPAT SDL_RWOPS_COMPAT

// ByteOrder Compat

#define BYTEORDER SDL_BYTEORDER
#ifdef SDL_FLOATWORDORDER
    #define FLOATWORDORDER SDL_FLOATWORDORDER
#else
    #define FLOATWORDORDER BYTEORDER
#endif
#define LIL_ENDIAN SDL_LIL_ENDIAN
#define BIG_ENDIAN SDL_BIG_ENDIAN
#define COMPAT_Swap16 SDL_Swap16
#define COMPAT_Swap32 SDL_Swap32
#define COMPAT_Swap64 SDL_Swap64

#define COMPAT_Quit SDL_Quit
